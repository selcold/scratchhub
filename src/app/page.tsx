...
export default function Home() {
  ...
  return (
    <>
      <div className="w-full md:w-[768px] mt-5 mx-auto">
        <div className="flex flex-row flex-nowrap sm:flex-wrap justify-between sm:justify-center">
          <div className="inline-block w[18.75em] sm:w-[calc(60%-20px)] mb-5"></div>
        </div>
      </div>
      <div className="flex items-center justify-center min-h-[calc(100vh_-_theme(spacing.16))]">
        {studios ? (
          <div className="text-center bg-white dark:bg-neutral-900 p-6 rounded-lg shadow-lg">
            <h1 className="text-2xl text-neutral-400 dark:text-neutral-500">
              近日公開
            </h1>
            <img
              src={studios.image}
            ...
            <details>
              ...
              <div className="text-gray-500">
                ...
                <p>
                  Comments Allowed: {studios.comments_allowed ? "Yes" : "No"}
                </p>
              </div>
            </details>
          </div>
